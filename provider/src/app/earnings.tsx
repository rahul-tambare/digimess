...
const styles = StyleSheet.create({
  ...
  ordersLabel: { fontSize: FontSizes.sm, color: Colors.darkTextSecondary, fontWeight: FontWeights.medium, marginBottom: 4, textAlign: 'center' },
  ordersValue: { fontSize: FontSizes.display, fontWeight: FontWeights.extrabold, color: Colors.textInverse, textAlign: 'center' },
  ...
  txnRight: { alignItems: 'flex-end', gap: Spacing.xs, justifyContent: 'center' },
  txnAmount: { fontSize: FontSizes.lg, fontWeight: FontWeights.bold, color: Colors.textPrimary, textAlign: 'right' },
